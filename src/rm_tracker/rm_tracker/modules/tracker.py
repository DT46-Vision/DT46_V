...
robot_list: List[RobotAppearance] = [
    ...
    RobotAppearance(id=2, armor_width=135.0, armor_height=125.0, robot_r1=0.3, robot_r2=0.275),
    ...
    RobotAppearance(id=8, armor_width=135.0, armor_height=125.0, robot_r1=0.3, robot_r2=0.275),
